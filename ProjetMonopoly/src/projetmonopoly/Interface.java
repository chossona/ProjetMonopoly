...
public class Interface {
    ...
    private final String ligne = "__________________________________________";
...
public void afficherInfosCarte(String s){
    ...
    public void afficherInfos(CarreauPropriete prop) {
        ...
        if (!(prop.getProprietaire() == null)) {
            proprietaire = prop.getProprietaire().getNomJoueur();
        }
   ...
   public boolean reponse() {
    ...
    public String couleurTexte(Carreau c) {
        if (c.getNumero() == 2 || c.getNumero() == 4) {
            ...
            return "\u001B[31m"; //rouge
        } else if (c.getNumero() == 27 || c.getNumero() == 28 || c.getNumero() == 30) {
            return "\u001B[33m"; //yellow
    ...
    public void affichagePlateau() {
        ...
        while (fin <= 7) {
            ...
            for (int d = 1; d <= 5; d++) {
                    ...
                    System.out.print(couleurTexte(this.getMonopoly().getCarreau().get(i)) + afficherLigneText( this.getMonopoly().getCarreau().get(i).getNomCarreau())+"\u001b[0m");
                i++;
            }
            System.out.println();
            i = i - 5;
            ...
            if (this.getMonopoly().getJoueur(j).getCarte_Caisse_Prison() || this.getMonopoly().getJoueur(j).getCarte_Chance_Prison()) {
                ...
                if ("oui" == (sc.nextLine())) {
                    ...
                    if (this.getMonopoly().getJoueur(j).getCarte_Caisse_Prison()) {
                        ...
                        this.getMonopoly().getJoueur(j).setCarte_Caisse_Prison(false);
                    }
